...
// const Basket = () => {
//   const  { getItems, clearBasket , decreaseQuantity,increaseQuantity, removeProduct }= useContext(cartContext);
//   const [cartItems,setCartItems] = useState([]);
//   const navigate = useNavigate();
//  // const { getItems, clearBasket } = context;
...
//         <div className="flex">
//         <div ><Link key={p.id} to={`/products/${p.id}`}>{p.title}</Link></div>
//         <div className="flex">
...
//             <div><UpIcon width={20} onClick={()=> setCartItems(increaseQuantity({id:p.id}))} /></div>
//             <div> <DownIcon width={20} onClick={()=> setCartItems(decreaseQuantity({id:p.id}))}/> </div>
//             <div><TrashIcon  width={20} onClick={()=> setCartItems(removeProduct({id:p.id}))}/></div>
//            </div>
...
//     const total =cartItems.reduce((total,currentItem)=>(currentItem.quantity * currentItem.price),0) //initialize the total value to 0
//    return total;
//   }
//   return (
//     <>
...
//           <div>
//             <button className="px-10 py-1 rounded-md bg-slate-200 hover:bg-slate-50" onClick={() => setCartItems(clearBasket())}>
//               Clear
//             </button>
//           </div>
